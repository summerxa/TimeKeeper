        ...
        fixed:
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        if persistent.namesaves and renpy.get_screen('save'):
                            action Show('prompt_savename', slot=slot)
                        else:
...
screen prompt_savename(slot):
    ...
    frame:
        ...
        textbutton _('Save'):
            xalign 0.3
            yalign 0.7
            action [FileSave(slot), Hide('prompt_savename')]

        textbutton _('Cancel'):
            xalign 0.7
            yalign 0.7
            action Hide('prompt_savename')
