...
screen btn_item(b):
    imagebutton:
        ...
        action [SetVariable('curholder', b), If('air' in invitems or (itemsAll[b['item']['id']]['stackable'] and invGetStack(b['item']['id']) >= 0), true=Function(update_inv), false=Show('popup_trade'))]
